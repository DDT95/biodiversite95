...
async function load(){
  ...
  try{
    ...
    state.communesLayer.bringToFront();map.invalidateSize();map.fitBounds(state.communesLayer.getBounds(),{padding:[4,4],animate:false});map.zoomIn(0.6,{animate:false});
